...
echo -e "${BLUE}xormove Git Hook Installer${NC}"
echo "==========================="
echo ""
...
echo "  • Updates version.h automatically with correct format"
echo ""
echo "1. Basic hooks (version update only - NOT RECOMMENDED)"
echo "   - pre-commit-basic: Only updates version.h"
...
echo "Example: 0.1.0_private_21-20250922-a1b2c3d4"
echo ""
...
echo "  • pre-commit hook updates version.h BEFORE each commit"
...
echo "  • View version: grep XORMOVE_VERSION_FULL include/version.h"
