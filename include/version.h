...
#define XORMOVE_VERSION_MINOR 2
#define XORMOVE_VERSION_PATCH 0
...
#define XORMOVE_VERSION_FULL "0.2.0_main_14-20251223-1461a7b"

// Helper macros
#define XORMOVE_VERSION_STRING "0.2.0"
#define XORMOVE_VERSION_WITH_PHASE "0.2.0"
